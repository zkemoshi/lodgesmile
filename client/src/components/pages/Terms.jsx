...
const Terms = () => {
  ...
  const company = 'Z&C Technologies';
  const site = 'lodgetz.com';
  const email = 'zkemoshi@gmail.com';
    ...
    <Container>
      <div className='container'>
        ...
        <div className='terms'>
          ...
          <hr />
          <h3 className='text-left my-1'>OVERVIEW</h3>

          <Typography variant='body1' className={classes.p}>
            This website is operated by {company}. Throughout the site, the
            terms 'we', 'us' and 'our' refer to {site}, tendmapya.com offers
          ...
          <h3 className='text-left my-1'>SECTION 1 - ONLINE STORE TERMS</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 2 - GENERAL CONDITIONS</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 7 - OPTIONAL TOOLS</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 8 - THIRD-PARTY LINKS</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 10 - PERSONAL INFORMATION</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 12 - PROHIBITED USES</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <Typography variant='body1' className={classes.p}>
            ...
            tendmapya.info, our directors, officers, employees, affiliates,
          ...
          <h3 className='text-left my-1'>SECTION 14 - INDEMNIFICATION</h3>
          <Typography variant='body1' className={classes.p}>
            You agree to indemnify, defend and hold harmless tendmapya.info and
          ...
          <h3 className='text-left my-1'>SECTION 15 - SEVERABILITY</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 16 - TERMINATION</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 17 - ENTIRE AGREEMENT</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>SECTION 18 - GOVERNING LAW</h3>
          <Typography variant='body1' className={classes.p}>
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of 3rd Floor EZM House, Dar es Salaam, 02,
            11000, Tanzania, United Republic of.
          </Typography>
          <h3 className='text-left my-1'>
          ...
          <h3 className='text-left my-1'>SECTION 20 - CONTACT INFORMATION</h3>
          <Typography variant='body1' className={classes.p}>
