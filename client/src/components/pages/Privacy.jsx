      ...
      <div className='container'>
        ...
        <div className='privacy'>
          ...
          <Typography variant='body1' className={classes.p}>
            At lodgetz.com, accessible from {site}, one of our main priorities
            is the privacy of our visitors. This Privacy Policy document
            contains types of information that is collected and recorded by{' '}
            {site} and how we use it. If you have additional questions or
            ...
            {site}. This policy is not applicable to any information collected
            offline or via channels other than this website.
          </Typography>
          <h3 className='text-left my-1'>CONSENT</h3>
          <Typography variant='body1' className={classes.p}>
            By using our website, you hereby consent to our Privacy Policy and
            agree to its terms.
          </Typography>
          <h3 className='text-left my-1'>INFORMATION WE COLLECT</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>LOG FILES</h3>
          <Typography variant='body1' className={classes.p}>
            ...
            Privacy Policy Generator and the Privacy Policy Template.
          </Typography>
          <h3 className='text-left my-1'>COOKIES AND WEB BEACONS</h3>
          <Typography variant='body1' className={classes.p}>
            Like any other website, {site} uses 'cookies'. These cookies are
          ...
          <Typography variant='body1' className={classes.p}>
            ...
            advertising partners of {site}. Third-party ad servers or ad
            ...
            appear on {site}, which are sent directly to users' browser. They
            automatically receive your IP address when this occurs. These
            technologies are used to measure the effectiveness of their
            advertising campaigns and/or to personalize the advertising content
            that you see on websites that you visit. Note that {site} has no
            access to or control over these cookies that are used by third-party
            advertisers.
          </Typography>
          <h3 className='text-left my-1'>THIRD PARTY PRIVACY POLICIES</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>GDPR DATA PROTECTION RIGHTS</h3>
          <Typography variant='body1' className={classes.p}>
          ...
          <h3 className='text-left my-1'>CHILDREN'S INFORMATION</h3>
          <Typography variant='body1' className={classes.p}>
